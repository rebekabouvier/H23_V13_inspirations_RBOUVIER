# Exploration des projets en création des étudiants.e.s de 3e année en TIM
...
### Les cours que je crois nécessaires pour le création de ce projet
Encore une fois, je crois que le cours d'Audio 1 est très important pour ce projet, car les élèves auront besoin de savoir comment faire un son ou une musique afin d'atteindre le résultat final, d'autant plus qu'ils désirent en faire deux différents. Ensuite, je crois que les élèves auraient besoin du cours objets intéractifs, car ils doivent savoir comment relier l'énergie créée par le velo aux lumières dans l'espace désiré et aussi d'être familier avec ce type d'insatllation. Dernièrement, je crois que le cours de domaines de multimédias serait peut-être un cours incontournable pour ces élèves, car ils doivent être très familier avec les ordinateurs et ses programmes et selon moi, pour créer autant de palettes de couleurs différentes sur des lumières je crois qu'il est essentiel de s'y connaitre plutôt bien.

Dans ce cas-ci, je ne connaissais rien au cours d'objets interactif, donc j'ai fait quelques recherches à son propos ce qui m'as amener à découvrir que ce cours consistait à connaitre comment fonctionnait les objets étant interactifs comme des capteurs, des microcontrôleurs, des DEL et pleins d'autres. À la fin de ce cours l'élève doit être capable d'intégrer des technologies éléctroniques à une oeuvre interactive.

### Ce que je crois ressentir durant ce projet
Durant cette expérimentation, je crois qu'au début je serai plus au moins émerveiller par la musique, car il n'y aura pas de lumière si le vélo n'est pas activé. Je ne crois pas vraiment que ce projet sera de mon gout, car je crois qu'à cause du vélo je ne serai pas concentrer et je trouve que cela nous donne moins le temps d'apprécier l'oeuvre. Par contre, je ne doute certainement pas de la beauté de l'oeuvre et je trouve intéressant l'idée d'ajouter plusieurs palettes de couleur aux lumières afin de créer un atmosphère différent, mais le fait de faire du vélo pour l'activer n'est vraiment pas à mon goût.
